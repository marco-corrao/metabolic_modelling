...
m_remove=cobra.io.load_json_model('Escherichia_coli_iCH360.json')
...
for r in m_remove.reactions:
    if r.id[0:3]=='EX_':
        to_delete.append(r)
m_remove.remove_reactions(to_delete)       

cobra.io.save_json_model(m_remove, 'model_wo_exchange/Escherichia_coli_iCH360_wo_exchange.json')
#cobra.io.write_sbml_model(m_remove, 'model_wo_exchange/Escherichia_coli_iCH360_wo_exchange.xml')
